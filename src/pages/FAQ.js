...
const FAQ = () => {
  ...
  return (
    ...
    <div className="flex relative">
            <div className="md:sticky container px-5 py-24 w-1/3">
                <div className="sticky bg-white rounded-lg p-8 flex flex-col w-full relative z-10 border border-gray-200 shadow-md">
        ...
        <div className="flex-row flex-1 space-y-3">
            ...
            <div className="mt-24 mr-4 bg-white rounded-lg p-8 flex flex-col relative z-10 border border-gray-200 shadow-md">
