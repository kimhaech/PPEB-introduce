    ...
    <div>
      ...
      <Fade bottom>
        ...
        <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">
          ...
          <br></br> 
          <p className="mx-auto leading-relaxed text-xl font-bold italic">
          "혼자서 하기 어려운 것들을 선후배의 도움을 받아 소속감을 가지고 협력하며
          </p>
          <p className="mx-auto leading-relaxed text-xl font-bold italic">
             다양한 활동 경험을 통해 뛰어난 개발자로 성장할 수 있는 기회를 만들어갑니다."
          </p>
        </div>
        </Fade>
